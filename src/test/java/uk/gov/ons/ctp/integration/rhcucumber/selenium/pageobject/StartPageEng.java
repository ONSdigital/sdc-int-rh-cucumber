...
@NoArgsConstructor
@AllArgsConstructor
public class StartPageEng extends PageObjectBase implements StartPage {

  public static final String START_URL_SUFFIX = "en/start/";
  private String testUPRN = "10023122451";

  public StartPageEng(final WebDriver driver, final String urlPrefix) {
    super(driver);
    classPrefix = "Start:";
